...
void MackieControl::prepare_selected_plugin_parameter_names(const selected_strip_struct *selected_strip, const plugin_multiplexer_struct *plugin_multiplexer)
{
	for(int i = 0; i < STRIPS_PER_CONTROLLER; i++){
