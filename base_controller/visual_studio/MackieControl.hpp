...
public:
	...
	void update_display(const struct plugin_parameter *selected_plugin, const plugin_multiplexer_c *plugin_multiplexer, int plugin_bank);
	void update_faders(const struct plugin_parameter *selected_plugin, const plugin_multiplexer_c *plugin_multiplexer, int plugin_bank);
	...
	void prepare_selected_plugin_parameter_names(const struct selected_strip_struct *selected_strip, const plugin_multiplexer_c *plugin_multiplexer);
